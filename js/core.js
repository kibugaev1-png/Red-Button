...
const WH = 260;               // высота мира в частицах
...
const ZONES = [
  ...
  },
  {
    ...
    desc: 'Скалы, обнажённая руда у поверхности и старый ствол, уходящий вниз.',
    danger: 'опасно', radMul: 1.2, zombies: 1.0, color: '#6a6f78'
  },
  {
